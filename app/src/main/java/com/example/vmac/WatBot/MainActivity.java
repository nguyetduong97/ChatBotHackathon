        ...
        Thread thread = new Thread(new Runnable(){
            public void run() {
                try {
                    ...
                    service.setUsernameAndPassword("233e364d-7cf1-42b2-9a66-931cfb5e1367", "IkMc2Yj36nLd");
                    MessageRequest newMessage = new MessageRequest.Builder().inputText(inputmessage).context(context).build();
                    MessageResponse response = service.message("08cf639f-f67b-4fa8-a362-9a6ef27a6c08", newMessage).execute();
